...
_T = {
    "welcome": {
        "ja": "ようこそ BrightStar 社内アシスタントへ。\n毎月「勤務表」と「経費」のExcelをこのトークに送って提出してください。",
        "zh": "欢迎使用 BrightStar 社内助手。\n每月把「勤务表（考勤）」和「经费」Excel 发到这里即可提交。",
    },
    "ask_name": {
    ...
    "menu_employee": {
        "ja": "■ 使い方\n・「勤務表」「経費」のExcelを送る → 提出（再提出も可）\n・テンプレ → 空白様式\n・履歴 → 自分の提出（ダウンロード可）",
        "zh": "■ 用法\n・发「勤务表」「经费」Excel → 提交（可重复提交）\n・模板 → 取空白样式\n・履历 → 看自己的提交（可下载）",
    },
    "menu_hr": {
    ...
    "ask_type": {
        "ja": "これは「勤務表（勤怠）」ですか「経費」ですか？ どちらか送信してください。",
        "zh": "这是「勤务表（考勤）」还是「经费」？请回复其一。",
    },
    "submit_ok": {
